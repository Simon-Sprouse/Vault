...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 15 00:19:07 2024
...
class Node:
    ...
    def printNode(self, depth=0):
        print("\t" * depth + f"'{self.key}' ({self.page}) [{self.number_of_children}]")
           ...
           for existing_key in list(root.edges.keys()):
               ...
               if match:
                   ...
                   if match == existing_key:
                       ...
                       parent_node.number_of_children = old_node.number_of_children + 2
                       parent_node.edges = {
